package com.example.playerswagger.service.impl;


import com.example.players.exceptions.ResourceNotFoundException;
import com.example.players.models.Player;


import com.example.playerswagger.dto.PlayerDto;
import com.example.playerswagger.repository.PlayerRepository;
import com.example.playerswagger.service.PlayerService;
...
public class PlayerServiceImpl implements PlayerService {
    ...
    public void deletePlayer(int id) {
        Player player = playerRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Player could not be deleted: " + id));
